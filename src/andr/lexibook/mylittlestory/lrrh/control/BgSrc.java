...
public class BgSrc {
    ...
    private int[] splashs = {R.drawable.eng__splash
            , R.drawable.fra__splash
            , R.drawable.deu__splash
            , R.drawable.esp__splash
            , R.drawable.ita__splash};
    ...
    private int[] fras = {R.drawable.fra_p01_bkg
            ...
            , R.drawable.fra_p08_bkg_cover
            , R.drawable.fra_p09_bkg
            , R.drawable.fra__p10_bkg
